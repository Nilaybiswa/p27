...
function setup() {
	...
	roofObject=new roof(500,50,230,20);
	bob1 = new bob(430,535,50);
	bob2 = new bob(470,535,50);
	bob3 = new bob(510,535,50);
	bob4 = new bob(530,535,50);
	bob5 = new bob(570,535,50);
...
//CHOOSE THE CORRECT OPTION TO APPLY A KEYPRESSED TO CHANGE THE POSITION OF BALL OBJECT TO THE LEFT WHEN UP ARROW KEY IS PRESSED
 ...
 function keyPressed() {
 	if (keyCode === UP_ARROW) {
 		Matter.Body.applyForce(bob1.body,{x:-60,y:-55});
 	}
 }
